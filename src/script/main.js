...
document.querySelector("#indent").addEventListener("change", (ev) => {
  ...
  document.querySelector("div.md-list").innerHTML = Markdown.parsed(
    document.querySelector("textarea.md-list").value || "Markdown Test",
    {
      ol: "list-group reset",
      ul: "list-group reset",
      li: "list-item",
...
window.addEventListener("keyup", (ev) => {
  ...
  document.querySelector("div.converted").innerHTML = Markdown.test(
    document.querySelector("body > main > textarea").value || "Markdown Test",
    {
      ol: "list-group reset",
      ul: "list-group reset",
      li: "list-item",
  ...
  document.querySelector("div.origin").innerHTML = Markdown.test(
    document.querySelector("textarea.md-list").value || "Markdown Test",
    {
      ol: "list-group reset",
      ul: "list-group reset",
